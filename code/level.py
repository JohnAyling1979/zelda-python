				...
				for col_index, col in enumerate(row):
					if col != '-1':
						...
						if style == 'boudary':
							...
							Tile((x, y), [self.visible_sprites, self.obstacle_sprites, self.attackable_sprites], style, choice(graphics['grass']))
						elif style == 'object':
							...
							if col == '394':
								...
								Enemey(monster_names[col], (x, y), [self.visible_sprites, self.attackable_sprites], self.obstacle_sprites, self.damage_player, self.trigger_death_particles)
...
class YSortCameraGroup(pygame.sprite.Group):
	...
	def enemy_update(self, player):
		enemey_sprites = [sprite for sprite in self.sprites() if hasattr(sprite, 'sprite_type') and sprite.sprite_type == 'enemy']

		for enemy in enemey_sprites:
